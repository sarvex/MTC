...
DeamonConnection::connectDataCall ()
{
    ...
    // set connection name
    QString name = DeamonSetting::getInstance ()->getName ();
    name.toWCharArray(rasDialParameters.szEntryName);

    // set connection username
    QString username = DeamonSetting::getInstance ()->getUsername ();
    username.toWCharArray(rasDialParameters.szUserName);

    // set connection password
    QString password = DeamonSetting::getInstance ()->getPassword ();
